        ...
        if(!CollectionUtils.isEmpty(addItemMember)){
            for(ItemMember itemMember: addItemMember) {
                ...
                totalSalary.setId(null)
                        ...
                        .setDeclareGrant((itemMemberUidItemSalary!=null && itemMemberUidItemSalary.get(uid)!=null)? itemMemberUidItemSalary.get(uid).getDeclareGrant(): totalSalary.getDeclareGrant())
                        .setPerformanceTotal((itemMemberUidPerformanceSalary!=null && itemMemberUidPerformanceSalary.get(uid)!=null) ? itemMemberUidPerformanceSalary.get(uid).getPerformanceSalary(): totalSalary.getPerformanceTotal())
                        .setDesignTotal((itemMemberUidDesignSalary != null && itemMemberUidDesignSalary.get(uid)!=null) ? itemMemberUidDesignSalary.get(uid).getSubtotal() : totalSalary.getDesignTotal())
                        .setTenderTotal((itemMemberUidBidSalary!=null && itemMemberUidBidSalary.get(uid)!=null)  ? itemMemberUidBidSalary.get(uid).getBidFee() : totalSalary.getTenderTotal())
                        .setScientificTotal((itemMemberUidScientificSalary !=null && itemMemberUidScientificSalary.get(uid)!=null) ? itemMemberUidScientificSalary.get(uid).getSubtotal(): totalSalary.getScientificTotal())
                        .setOutSubsidy((itemMemberUidOutSubsidy !=null && itemMemberUidOutSubsidy.get(uid)!=null)  ? itemMemberUidOutSubsidy.get(uid).getOutSubsidy(): totalSalary.getOutSubsidy())
                        .setNightSubsidy((itemMemberUidNightSubsidy!=null && itemMemberUidNightSubsidy.get(uid)!=null)  ? itemMemberUidNightSubsidy.get(uid).getNightSubsidy() :totalSalary.getNightSubsidy())
                        .setOvertimeSubsidy((itemMemberUidOvertimeSubsidy!=null && itemMemberUidOvertimeSubsidy.get(uid)!=null)  ? itemMemberUidOvertimeSubsidy.get(uid).getOvertimeSubsidy() : totalSalary.getOvertimeSubsidy())
                        .setHeatingSubsidy((itemMemberUidHeatingSubsidy!=null && itemMemberUidHeatingSubsidy.get(uid)!=null)  ? itemMemberUidHeatingSubsidy.get(uid).getHeatingSubsidy(): totalSalary.getHeatingSubsidy())
        ...
        if(!CollectionUtils.isEmpty(updateItemMember)){
            ...
            for(TotalSalary oldTotalSalary : updateItemMember){
                ...
                oldTotalSalary.setItemName(item.getItemName())
                        ...
                        .setNumber(member.getNumber())
                        .setName(member.getName())
                        .setDeclareGrant((itemMemberUidItemSalary!=null && itemMemberUidItemSalary.get(uid)!=null)? itemMemberUidItemSalary.get(uid).getDeclareGrant(): oldTotalSalary.getDeclareGrant())
                        .setPerformanceTotal((itemMemberUidPerformanceSalary!=null && itemMemberUidPerformanceSalary.get(uid)!=null) ? itemMemberUidPerformanceSalary.get(uid).getPerformanceSalary(): oldTotalSalary.getPerformanceTotal())
                        .setDesignTotal((itemMemberUidDesignSalary != null && itemMemberUidDesignSalary.get(uid)!=null) ? itemMemberUidDesignSalary.get(uid).getSubtotal() : oldTotalSalary.getDesignTotal())
                        .setTenderTotal((itemMemberUidBidSalary!=null && itemMemberUidBidSalary.get(uid)!=null)  ? itemMemberUidBidSalary.get(uid).getBidFee() : oldTotalSalary.getTenderTotal())
                        .setScientificTotal((itemMemberUidScientificSalary !=null && itemMemberUidScientificSalary.get(uid)!=null) ? itemMemberUidScientificSalary.get(uid).getSubtotal(): oldTotalSalary.getScientificTotal())
                        .setOutSubsidy((itemMemberUidOutSubsidy !=null && itemMemberUidOutSubsidy.get(uid)!=null)  ? itemMemberUidOutSubsidy.get(uid).getOutSubsidy(): oldTotalSalary.getOutSubsidy())
                        .setNightSubsidy((itemMemberUidNightSubsidy!=null && itemMemberUidNightSubsidy.get(uid)!=null)  ? itemMemberUidNightSubsidy.get(uid).getNightSubsidy() :oldTotalSalary.getNightSubsidy())
                        .setOvertimeSubsidy((itemMemberUidOvertimeSubsidy!=null && itemMemberUidOvertimeSubsidy.get(uid)!=null)  ? itemMemberUidOvertimeSubsidy.get(uid).getOvertimeSubsidy() : oldTotalSalary.getOvertimeSubsidy())
                        .setHeatingSubsidy((itemMemberUidHeatingSubsidy!=null && itemMemberUidHeatingSubsidy.get(uid)!=null)  ? itemMemberUidHeatingSubsidy.get(uid).getHeatingSubsidy(): oldTotalSalary.getHeatingSubsidy())
                        .setDeclareTime(new Date())
                        .setUpdatedBy(currentNumber)
                        .setUpdatedTime(new Date());
